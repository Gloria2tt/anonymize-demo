...
class StableDiffusionControlNetPipeline(
    ...
    def __call__(
        ...
        controlnet_hidden = None,
        encoder_hidden_states_2 = None,
        encoder_hidden_states_a = None,
        ...
        **kwargs,
        ...
        if isinstance(controlnet, ControlNetModel):
            ...
            print("contorlnet_cond input shape",image.shape)
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                print("control_model_input",control_model_input.shape) ### 2 x 1 x 256 x 1024
                print("original input shape",controlnet_prompt_embeds.shape)#### 2 x 77 x 768
                #print("min controlnet hiden:",controlnet_hidden.shape)
                ...
                print("unet input shape",latent_model_input.shape)
                print('prompt embeds',prompt_embeds,len(prompt_embeds))
