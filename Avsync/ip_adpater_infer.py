...
from foleycrafter.models.adapters.ip_adapter import trans_index
import torch
...
from utils_ import is_torch2_available, get_generator
...
class IPAdapter:
    def __init__(self, sd_pipe, image_encoder_path, ip_ckpt, model_path, device, num_tokens=4):
        self.device = device
        ...
        # load image encoderimage_encoder = CLIPVisionModelWithProjection.from_pretrained(
        ...
        # image proj model
        self.image_proj_model,self.video_proj_model = self.init_proj()
        self.image_proj_model.to(self.device)
        self.video_proj_model.to(self.device)
    ...
    def init_proj(self):
        ...
        video_proj_model = VideoProjmodel(cross_attention_dim=self.pipe.unet.config.cross_attention_dim,
                                          clip_embeddings_dim=self.image_encoder.config.projection_dim,
                                          )
        return image_proj_model,video_proj_model
    ...
    def load_ip_adapter(self):
        ...
        #print(state_dict['ip_adapter'])
        self.image_proj_model.load_state_dict(state_dict["image_proj"])
        ip_layers = torch.nn.ModuleList(self.pipe.unet.attn_processors.values())
        new_ip = trans_index(state_dict)
        #ip_layers.load_state_dict(state_dict['ip_adapter'])
        ip_layers.load_state_dict(new_ip)
    ...
    def load_unet3(self,model_path):
        ...
        self.pipe.unet.load_state_dict(model_state_dict)
    ...
    def generate(
        ...
        **kwargs,
        ...
        with torch.inference_mode():
            ...
            prompt_embeds = torch.cat([prompt_embeds_, image_prompt_embeds], dim=1)### b x 81 x dim
        ...
        images = self.pipe(
            ...
            encoder_hidden_satates_2=encoder_hidden_satates_2,
